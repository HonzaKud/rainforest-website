const Footer = () => {
    return (
      <footer className="w-full bg-green-950 text-white relative pt-10 pb-8 overflow-hidden">
        {/* Vlna nahoře */}
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute w-[300px] h-[300px] bg-green-700 blur-[80px] opacity-30 bottom-10 right-1/4" />
        </div>
  
        {/* Obsah footeru na plnou šířku */}
        <div className="flex flex-col md:flex-row justify-between items-center px-6 md:px-16 w-full">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <a href="#" className="hover:text-green-400 transition">Kontakt</a>
          </div>
        </div>
      </footer>
    );
